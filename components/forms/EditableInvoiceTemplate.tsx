              ...
              <div className="text-sm text-gray-700 space-y-1">
                <div>
                  ...
                  <input
                    ...
                    readOnly={readOnly}
                    className={`inline-block w-40 text-sm px-2 py-1 ${inputClass}`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    readOnly={readOnly}
                    className={`inline-block w-36 text-sm px-2 py-1 ${inputClass}`}
                  />
                </div>
              ...
              <div className="space-y-2">
                <div className="text-sm">
                  ...
                  <input
                    ...
                    readOnly={readOnly}
                    placeholder={!readOnly ? 'EV Charging Station Infrastructure' : ''}
                    className={`w-full text-sm px-2 py-1 mt-1 ${inputClass}`}
                  />
                </div>
                <div className="text-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm">
                  ...
                  <input
                    ...
                    readOnly={readOnly}
                    placeholder={!readOnly ? '123 Main St, San Jose, CA 95113' : ''}
                    className={`w-full text-sm px-2 py-1 mt-1 ${inputClass}`}
                  />
                </div>
              </div>
            ...
            <div className="border border-gray-300 rounded-lg overflow-hidden">
              <table className="w-full text-sm">
                <thead className="bg-gradient-to-r from-gray-100 to-gray-200">
                  <tr>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 w-12">Item #</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Description</th>
                    <th className="text-center py-3 px-4 font-semibold text-gray-700 w-16">Qty</th>
                    <th className="text-center py-3 px-4 font-semibold text-gray-700 w-16">Unit</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700 w-28">Material</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700 w-28">Labor</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700 w-32">Total</th>
                ...
                <tbody>
                  {data.lineItems.map((item, index) => (
                    ...
                    >
                      <td className="py-2 px-4 border-t border-gray-200 text-center">{index + 1}</td>
                      ...
                      <td className="py-2 px-4 border-t border-gray-200">
                        <input
                          ...
                          readOnly={readOnly}
                          placeholder={!readOnly ? '2400.00' : ''}
                          className={`text-sm px-2 py-1 text-right ${cellInputClass}`}
                        />
                      </td>
                      <td className="py-2 px-4 border-t border-gray-200 text-right font-semibold">
                        {formatCurrency(item.total)}
                      </td>
                      {!readOnly && (
                        <td className="py-2 px-4 border-t border-gray-200 text-center no-print">
                          <button
                            type="button"
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <textarea
              ...
              className={`w-full text-xs text-gray-700 ${
                readOnly ? 'border-none bg-transparent resize-none' : 'border border-blue-200 bg-white p-2 rounded focus:ring-2 focus:ring-blue-400'
              }`}
            />
          </div>
