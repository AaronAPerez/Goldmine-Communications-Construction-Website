...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Get a free quote for telecommunications and construction services. Serving Northern California, Central Valley & Bay Area. Call (925) 305-5980.',
  ...
  twitter: {
    ...
    description: 'Get a free quote for telecommunications and construction services. Call (925) 305-5980.',
